...
export interface ApplicantKeywordCreationAttributes extends Optional<IApplicantKeywordAttributes, 'id'> {}
...
ApplicantKeyword.init(
  ...
  {
    modelName: 'ApplicantKeyword',
    tableName: 'applicant_keyword',
    sequelize,
